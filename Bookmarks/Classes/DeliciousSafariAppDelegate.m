...
- (void)applicationDidFinishLaunching:(UIApplication *)application
{
	...
	[[DXDeliciousAPIManager sharedManager] addObserver:self forKeyPath:@"isUpdating" options:NSKeyValueObservingOptionNew context:nil];
...
{
	if(saveBookmarkViewController == nil)
		saveBookmarkViewController = [[SaveBookmarkViewController alloc] initWithNibName:@"SaveBookmarkView" bundle:[NSBundle mainBundle]];
...
- (void)dealloc
{
	[[DXDeliciousAPIManager sharedManager] removeObserver:self forKeyPath:@"isUpdating"];
