...
- (NSMenu*)buildSearchMenu
{
	...
	NSMenuItem* findByTagsItem = [[NSMenuItem alloc] initWithTitle:DXLocalizedString(@"Find by Tags", @"Find by Tags search option")
															action:@selector(selectScope:) keyEquivalent:@""];
	...
	NSMenuItem* findByTitleItem = [[NSMenuItem alloc] initWithTitle:DXLocalizedString(@"Find by Title", @"Find by Title search option")
															 action:@selector(selectScope:) keyEquivalent:@""];
	...
	NSMenuItem* keepSearchResultsOpenItem = [[NSMenuItem alloc] initWithTitle:DXLocalizedString(@"Keep Open", @"Keep open search option")
																	   action:@selector(keepSearchResultWindowOpen:) keyEquivalent:@""];
