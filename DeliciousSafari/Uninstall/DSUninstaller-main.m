...
int main(int argc, char **argv)
{
	...
	NSMutableArray *pathsToRemove = [NSMutableArray arrayWithObjects:
									 ...
									 @"/Library/LaunchAgents/com.delicioussafari.DeliciousSafariAgent.plist", // old launchd plist
									 @"/Library/LaunchAgents/com.delicioussafari.DSAgent.plist", // new launchd plist
