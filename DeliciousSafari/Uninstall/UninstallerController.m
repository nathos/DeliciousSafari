...
-(void)performUninstall:(id)arg
{
	...
	// Unload the old launchd plist in the user's session, in case it's there.
	system("launchctl unload -S Aqua /Library/LaunchAgents/com.delicioussafari.DeliciousSafariAgent.plist");
	
	// Unload the new launchd plist.
	system("launchctl unload -S Aqua /Library/LaunchAgents/com.delicioussafari.DSAgent.plist");
